...
| Ordinal and multi-task learning | `coral2020`, `crawshaw2020mtl`, `kendall2018multi`, `chen2018gradnorm`, `yu2020pcgrad`, `standley2020tasks`, `misra2016crossstitch`, `liu2019mtan`, `attri2025saamvetnet` | Supports design alternatives. The executed Run 1 head is explicitly not mislabeled as CORAL, and planned MTL methods are not reported as completed. |
