...
\begin{tabular}{|p{2.8cm}|p{4cm}|p{1.8cm}|p{2.2cm}|p{2cm}|}
\hline
...
\begin{tabular}{|p{2.5cm}|p{3.8cm}|p{2cm}|p{2cm}|p{2.5cm}|}
\hline
...
\begin{tabular}{|p{2.8cm}|p{4cm}|p{2.2cm}|p{2cm}|p{1.9cm}|}
\hline
\textbf{Reference} & \textbf{Architecture} & \textbf{Input} & \textbf{Accuracy} & \textbf{Dataset} \\
\hline
...
\begin{tabular}{|p{3.2cm}|p{3.5cm}|p{2.2cm}|p{4.5cm}|}
\hline
...
\label{tab:summary}
\begin{tabular}{|p{3.2cm}|p{2cm}|p{1.8cm}|p{3.2cm}|p{2.8cm}|}
\hline
