...
INPUT_CSV = str(REPO_ROOT / "datasets" / "bcs" / "sciencedb_bcs_index.csv")
OUTPUT_CSV = str(REPO_ROOT / "datasets" / "bcs" / "sciencedb_bcs_cropped_index.csv")
CROPPED_DIR = str(REPO_ROOT / "datasets" / "bcs" / "sciencedb_bcs_cropped")
