...
def save_loss_curve(train_losses):
    ...
    plt.title("Behavior CE Ablation Training Loss Curve")
    plt.grid(True)
    plt.tight_layout()
...
def write_results(
    ...
    text = f"""---CONTEXT 3 BEHAVIOR CE ABLATION---
...
def main():
    ...
    criterion = nn.CrossEntropyLoss()  # Replaced FocalLoss
