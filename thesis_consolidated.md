...
\newcommand*[6cm]{
    \parbox{#1}{
        ...
        \includegraphics[height=1.5cm, keepaspectratio]#2
[-4pt] 
        \hrulefill\par
        #3
    }
...
**Student's Full Name & Signature:**
    ...
    [Signature Image: sig_hasin.png Hasin Ishrak   22201133 
    
    [Signature Image: sig_namira.png] Namira Abrar Haque   22201191
    
     
    

    [Signature Image: sig_sanjida.png] Sanjida Akter Bithi   22201180
    
    [Signature Image: sig_shouvik.png] Shouvik Banik   23101295
    
     
    

    [Signature Image: sig_nusrat.png] Nusrat Lamya Faruk   24241182
...
\renewcommand*[6cm]{
    \parbox{#1}{
        ...
        \ifx\hfuzz#2\hfuzz\else\includegraphics[height=1.2cm, keepaspectratio]#2
[-2pt]\fi 
        \hrulefill\par
        \small #3
    }
...
(Member)
 ...
 Dr. Md. Khalilur Rahman Professor Department of Computer Science and Engineering Brac University

Co-Supervisor:

(Member)

 Mehedi Hasan Emo Lecturer Department of Computer Science and Engineering Brac University

Thesis Coordinator:

(Member)

 [Signature Image: sig_gra.jpg Dr. Md. Golam Rabiul Alam Professor Department of Computer Science and Engineering Brac University

Head of Department:

(Chair)

 Dr. Sadia Hamid Kazi Associate Professor Department of Computer Science and Engineering Brac University
...
Body condition scoring represents a highly studied task in cattle computer vision literature, with numerous papers addressing automated BCS assessment. Yao et al. (2026) [yao2026jds2] developed an automated dairy cattle body condition scoring system using side-view images and deep learning, demonstrating that robust feature extraction can effectively estimate body fat reserves. Liu et al. (2025) [liu2025vets] proposed a novel lightweight scoring model for edge devices based on tail features and attention mechanisms, focusing on real-time inference constraints on farm deployments. Guzhva et al. (2026) [guzhva2026s415] tackled a BCS-adjacent problem by employing LIDAR-enhanced Mask R-CNN segmentation for precision weight estimation in dairy cattle using smartphone imaging. Finally, Antognoli et al. (2025) [antognoli2025ani1] provided a comprehensive literature review of current computer vision applications in dairy farm management, highlighting BCS as a primary metric for systemic health evaluation.

**Table (tab:bcs_papers): Summary of Body Condition Scoring Papers**

| **Reference** | **Architecture** | **Input** | **Type** | **Dataset** |
| -- | -- | -- | -- | -- |
| Yao 2026 [yao2026jds2] | Deep Learning | Side-view RGB | Empirical | Various |
| Liu 2025 [liu2025vets] | Lightweight CNN + Attention | Tail Features | Empirical | Various |
| Guzhva 2026 [guzhva2026s415] | Mask R-CNN + LIDAR | RGB-D / Smartphone | Empirical | Various |
| Antognoli 2025 [antognoli2025ani1] | N/A (Review) | Vision/Video | Review | N/A |

### Lameness Detection Research

Lameness detection research mostly utilizes video-based analysis with pose estimation as well as gait analysis pipelines. Sohan et al. (2025) [sohan2025s415] developed a lameness detection system focusing on the extraction of locomotion patterns from video using spatiotemporal deep learning to achieve robust classification. Similarly, Szyc et al. (2025) [szyc2025s251] introduced a video-based automated lameness detection framework for dairy cows, demonstrating the potential of sequential analysis for identifying abnormal gait signatures. 
...
| **Reference** | **Architecture** | **Input** | **Type** | **Innovation** |
| -- | -- | -- | -- | -- |
| Sohan 2025 [sohan2025s415] | Spatiotemporal DL | RGB Video | Empirical | Video-based Lameness |
| Szyc 2025 [szyc2025s251] | Deep Learning | RGB Video | Empirical | Video-based Lameness |

### Behavior Recognition Research

Behavior recognition covers vision-based as well as sensor-based approaches. Asim et al. (2026) [asim2026s260] contributed to the field by leveraging an advanced deep learning approach for analyzing cattle farming activity, focusing on robust monitoring using sensor data.

**Table (tab:behavior_papers): Summary of Behavior Recognition Papers**

| **Reference** | **Architecture** | **Input** | **Type** | **Dataset** |
| -- | -- | -- | -- | -- |
| Asim 2026 [asim2026s260] | Deep Learning | Sensor Data | Empirical | Various |
...
Beyond direct cattle monitoring, several studies provide foundational knowledge for multi-task learning (MTL) approaches across diverse agricultural domains, demonstrating the broad applicability of these architectures. Shalaldeh et al. (2026) [shalaldeh2026biol] investigated hybrid deep learning and multimodal feature fusion for estimating ewe live weight and carcass traits, showcasing MTL's utility in sheep farming. Attri et al. (2025) [attri2025ms90] proposed SAAM-VetNet, an attention-based multi-task framework for animal disease detection and severity grading. Extending beyond livestock, Sandal et al. (2026) [sandal2026v1] reviewed deep learning methods for tomato disease detection and severity assessment, while Bu et al. (2026) [bu2026jsaa] explored self-supervised MTL for spectral detection in pears, illustrating cross-domain efficiency gains.

Furthermore, several comprehensive survey papers outline the broader landscape of precision livestock farming (PLF) and computer vision. Zin et al. (2026) [zin2026ab26] and Sani et al. (2026) [sani2026ab25] reviewed AI-driven technologies and challenges in PLF, respectively. Palma et al. (2025) [palma2025ani1] provided a scoping review of data analytics in dairy farms, and Lee et al. (2026) [lee2026ab26] reviewed biosensors for decoding animal needs. Finally, studies such as Paneru et al. (2026) [paneru2026jpsj] on poultry welfare and Gonçalves et al. (2025) [gonçalves2025skaf] on ultrasound-based pregnancy diagnosis highlight the expanding role of computer vision in allied agricultural tasks. Crawshaw's (2020) [crawshaw2020mtl] survey on deep multi-task learning remains a foundational taxonomy guiding our architectural choices.

**Table (tab:mtl_papers): Summary of MTL, Survey, and Cross-Domain Papers**

| **Reference** | **Focus Domain** | **Type** | **Key Contribution** |
| -- | -- | -- | -- |
| Shalaldeh 2026 [shalaldeh2026biol] | Sheep (Ewes) | Empirical | Multimodal MTL for weight estimation |
| Attri 2025 [attri2025ms90] | General Livestock | Empirical | SAAM-VetNet multi-task disease detection |
| Sandal 2026 [sandal2026v1] | Tomatoes | Review | Plant disease assessment MTL |
| Bu 2026 [bu2026jsaa] | Pears | Empirical | Spectral self-supervised MTL |
| Zin 2026 [zin2026ab26] | General PLF | Review | Computer vision in PLF |
| Sani 2026 [sani2026ab25] | General PLF | Review | PLF challenges and opportunities |
| Palma 2025 [palma2025ani1] | Dairy Farms | Review | AI and Data Analytics scoping review |
| Crawshaw 2020 [crawshaw2020mtl] | Deep Learning | Review | MTL taxonomy and guidelines |
...
| -- | -- | -- | -- | -- |
| EfficientNet + Attention [liu2025vets] | RGB BCS | 91.10% | High accuracy, lightweight | Single task |
| YOLO-based [yao2026jds2] | RGB BCS | [VERIFY] | Edge-ready | Single task |
| Spatiotemporal DL [sohan2025s415] | RGB Lameness | [VERIFY] | Excellent detection | Single task |
| Advanced DL [asim2026s260] | Sensor Behavior | 91.11% | Temporal modeling | Requires sensors |
| Deep Metric Learning [andrew2021opencows] | RGB ID | 98.2% | Robust identification | Needs overhead camera |
| MTL Survey [crawshaw2020mtl] | Cross-platform | N/A | Guidelines | No implementation |
...
### Dataset Profiles
    ...
    - **CBVD-5 Dataset [cbvd5**: Used exclusively as an independent test set for behavior, consisting of 2,000 balanced images of cattle behaviors to evaluate model generalization under domain shift. Note: While the dataset name implies 5 classes, our evaluation mapped it to 4 overlapping classes (Standing, Feeding, Drinking, Lying) to match our taxonomy.
...
The feature vector is routed to four independent task heads:
    ...
    - **Behavior Head:** A linear classification layer projecting the 1,280 features to 7 behavior logits for frame-level prediction. In the spatiotemporal multi-task configuration, the sequence of feature vectors is processed through the shared LSTM pathway before classification.
...
| Nusrat | EfficientNet-B0 | 24 | **0.7631** | **0.7445** | 24 |
...
*[Figure (fig:behavior_loss_curve): Training loss curve for the behavior recognition single-task model (EfficientNet-B0).]*

**Table (tab:behavior_per_class): EfficientNet-B0 behavior per-class accuracy on the MmCows test set.**
...
| Nusrat | EfficientNet-B0 (Spatial) | 10 | **0.9829** | **93.05%** | **0.9483** |
...
| Nusrat | EfficientNet-B0 + CBAM | 10 | **0.5508** | **87.06%** | **86.49%** |

It is important to note that the comparison in Table tab:id_baselines is budget-matched rather than convergence-matched. All backbones were trained with a fixed 10-epoch budget. As indicated by the high final training losses for ResNet-18 (2.4158) and ResNet-50 (2.1213), these deeper models had not yet converged within the 10 epochs, making the comparison somewhat unfair to the ResNet architectures. [VERIFY: ideally retrain ResNets to convergence.]
...
### Ablation 3: Cross-Dataset Modality Comparison
...
| -- | -- | -- | -- | -- | -- |
| BCS | Yao et al. (2026) [yao2026jds2] | Various | Accuracy / MAE | [VERIFY: published accuracy] | 90.50% Acc ($± 0.25$) / 0.5566 MAE |
| Behavior | Asim et al. (2026) [asim2026s260] | Sensor Data | Accuracy / Macro F1 | 91.11% Acc | 74.45% Macro F1 |
| Lameness | Sohan et al. (2025) [sohan2025s415] | RGB-D | ROC-AUC | [VERIFY: published AUC] | 0.9829 AUC (Spatial) / 1.0000 AUC (Sequence)* |
| Cow ID | OpenCows2020 Baseline | OpenCows2020 | Top-1 Accuracy | $\sim$86.00% Top-1 | 86.49% Top-1 (Spatial) / 97.58% Top-1 (Sequence) |

As shown in Table tab:sota_comparison, our results compare favorably with existing literature, though direct comparison is often complicated by different evaluation metrics. For the BCS task, Yao et al. (2026) [yao2026jds2] reported [VERIFY: published accuracy] accuracy, which is compared against our within-one-class accuracy ($\text{Acc}_{± 1}$) of 90.50% (corresponding to a $±0.25$ BCS step tolerance), alongside our low Test MAE of 0.5566. For behavior recognition, Asim et al. (2026) [asim2026s260] reported 91.11% overall accuracy using sensor data. In contrast, our vision-based model achieved a strong Macro F1-score of 0.7445 on the highly imbalanced MmCows dataset, which penalizes all classes equally and represents a more robust indicator under severe class imbalance. For lameness detection, our spatiotemporal sequence model achieved an uncalibrated 80.00% accuracy (1.0000 AUC) on the CattleLameness dataset, compared to Sohan et al. (2025) [sohan2025s415] who reported [VERIFY: published AUC]. However, this comparison must be qualified by the massive difference in dataset scale and the risk of overfitting: our perfect sequence AUC score is achieved on a limited sample set of 50 video clips, representing a preliminary proof-of-concept rather than definitive clinical superiority, and our spatial AUC of 0.9829 likely suffers from identity and background leakage. Finally, for individual cow identification, our spatial baseline achieved 86.49% Top-1 accuracy, matching the OpenCows2020 baseline of $\sim$86%, while our spatiotemporal sequence model improved this to 97.58% through temporal majority voting across the video frames. Critically, our entire framework relies exclusively on public datasets, which enables independent reproduction compared to private baselines.
...
This thesis provides several key contributions to the domain of Precision Livestock Farming (PLF) and agricultural computer vision:
    ...
    - **Commitment to Open Evaluation:** Unlike the majority of agricultural computer vision literature which relies on private datasets, our study was designed, trained, and validated exclusively on publicly available datasets (ScienceDB, Dryad, MmCows, CattleLameness, OpenCows2020, CBVD-5), establishing a standardized benchmark to enable future reproduction.
...
## Limitations
Several critical limitations must be addressed before clinical deployment:

    - **Data Leakage and Dataset Scale:** The perfect lameness results (1.0000 AUC) were achieved via post-hoc threshold tuning on a highly constrained test set of only 50 videos, introducing severe data leakage and overfitting risks. Spatial metrics similarly suffer from identity leakage across video frames.
    - **Clinical Range Representation:** The ScienceDB BCS dataset only covers ranges from 3.25 to 4.25, meaning the model lacks exposure to clinically critical thin ($<2.5$) and fat ($>4.5$) conditions.
    - **Domain Shift Sensitivity:** Cross-dataset generalization dropped significantly (F1 0.1245 on CBVD-5) due to environmental domain shifts.
    - **Evaluation Constraints:** Single-run experiments limit statistical confidence, uncontrolled modality ablations limit causal claims, and deep backbones like ResNet were evaluated under fixed budget constraints rather than convergence parity.
...
- **[antognoli2025ani1]** Antognoli, V, Presutti, L, Bovo, M, Torreggiani, D, Tassinari, P (2025). *Computer Vision in Dairy Farm Management: A Literature Review of Current Applications and Future Perspectives.*. Animals. DOI: https://doi.org/10.3390/ani15172508
- **[attri2025ms90]** Attri, I, Vanita, B, Rajput, R, Awasthi, LK, Thakur, A, Tripathi, D, Pathak, V, Shukla, P, Gupta, D (2025). *SAAM-VetNet: an attention-based multi-task framework for animal disease detection and severity grading.*. [VERIFY: Journal Name for DOI 10.1097/ms9.0000000000003728]. DOI: https://doi.org/10.1097/ms9.0000000000003728
- **[gonçalves2025skaf]** Gonçalves, LM, Fontes, PLP, Alves, AAC (2025). *Computer vision analysis of luteal color Doppler ultrasonography for early and automated pregnancy diagnosis in Bos taurus beef cows.*. Journal of Animal Science. DOI: https://doi.org/10.1093/jas/skaf166
- **[liu2025vets]** Liu, F, Zhang, Y, Liu, Y, Li, J, Li, M, Yao, J (2025). *A Novel Lightweight Dairy Cattle Body Condition Scoring Model for Edge Devices Based on Tail Features and Attention Mechanisms.*. Veterinary Sciences. DOI: https://doi.org/10.3390/vetsci12090906
- **[palma2025ani1]** Palma, O, Plà-Aragonés, LM, Mac Cawley, A, Albornoz, VM (2025). *AI and Data Analytics in the Dairy Farms: A Scoping Review.*. Animals. DOI: https://doi.org/10.3390/ani15091291
- **[sohan2025s415]** Sohan, MF, Alzubi, R, Alzoubi, H, Albalawi, E, Hafez, AHA (2025). *Direct video-based spatiotemporal deep learning for cattle lameness detection.*. Scientific Reports. DOI: https://doi.org/10.1038/s41598-025-29118-8
- **[szyc2025s251]** Szyc, K, Hebda, M, Dembiński, K, Zdunek, M, Unold, O (2025). *Video-Based Automated Lameness Detection for Dairy Cows.*. Sensors. DOI: https://doi.org/10.3390/s25185771
- **[asim2026s260]** Asim, M, Anam, B, Ali, MN, Kim, BS (2026). *Cattle Farming Activity Monitoring Using Advanced Deep Learning Approach.*. Sensors. DOI: https://doi.org/10.3390/s26030785
- **[bu2026jsaa]** Bu, Y, Luo, J, Gong, C, Zhang, J, Wu, B, Wang, D, Guo, W (2026). *Dual-channel self-supervised multi-task learning for spectral detection of soluble solids content and firmness in Korla fragrant pears.*. Spectrochimica Acta Part A: Molecular and Biomolecular Spectroscopy. DOI: https://doi.org/10.1016/j.saa.2026.127684
- **[guzhva2026s415]** Guzhva, O, Ternman, E, Lindberg, M, Telezhenko, E, Kronqvist, C (2026). *PickAMoo: LIDAR-enhanced mask R-CNN segmentation for precision weight estimation in dairy cattle using smartphone imaging.*. Scientific Reports. DOI: https://doi.org/10.1038/s41598-026-54742-3
- **[lee2026ab26]** Lee, M, Tedeschi, LO, Seo, S (2026). *- Invited Review - Biosensors in precision livestock farming in dairy production: decoding animals' needs.*. Animal Bioscience. DOI: https://doi.org/10.5713/ab.260154
- **[paneru2026jpsj]** Paneru, B, Dhungana, A, Dahal, S, Ritz, CW, Kim, W, Liu, T, Chai, L (2026). *Computer vision models for precision poultry farming: A narrative review of behavioral and welfare monitoring studies.*. Poultry Science. DOI: https://doi.org/10.1016/j.psj.2026.106887
- **[sandal2026v1]** Sandal, S, Ghosh, S (2026). *Deep Learning for Tomato Disease Detection and Severity Assessment: A Systematic Analytical Review of Methods, Datasets, and Challenges*. Research Square. DOI: https://doi.org/10.21203/rs.3.rs-9600064/v1
- **[sani2026ab25]** Sani, MI, Voort, MV, Tekinerdogan, B, Hogeveen, H (2026). *- Invited Review - Application of precision livestock farming: challenges and opportunities.*. Animal Bioscience. DOI: https://doi.org/10.5713/ab.250895
- **[shalaldeh2026biol]** Shalaldeh, A, Safa, M, Logan, C, Othman, M (2026). *Estimation of Ewe Live Weight and Carcass Traits Using Advanced Hybrid Deep Learning and Multimodal Feature Fusion.*. Biology. DOI: https://doi.org/10.3390/biology15100815
- **[yao2026jds2]** Yao, L, Kong, F, Hong, W, Liu, J, Li, X, Fan, Z, Lei, L (2026). *Automated dairy cattle body condition score using side-view images and deep learning.*. Journal of Dairy Science. DOI: https://doi.org/10.3168/jds.2025-27759
- **[zin2026ab26]** Zin, TT, Tin, P (2026). *- Invited Review - Computer vision in precision livestock farming: artificial intelligence-driven technologies and applications for sustainable animal production.*. Animal Bioscience. DOI: https://doi.org/10.5713/ab.260165
- **[cbvd5]** [VERIFY: Dataset Author] (2026). *Cattle Behavior Video Dataset (CBVD-5)*. URL: [VERIFY: Dataset URL]