...
\textbf{Spatiotemporal Multi-Task} & \textbf{0.7849} & \textbf{0.4775} & \textbf{100.00\% (Sequence)} & \textbf{1.0000 (Sequence)} & \textbf{97.18\%} \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\addplot[fill=cyan!60, draw=cyan!80!black] coordinates {(Behavior F1,0.37) (Lameness Acc,0.94) (Lameness AUC,0.99) (ID Acc,0.96)};
\addplot[fill=orange!60, draw=orange!80!black] coordinates {(Behavior F1,0.48) (Lameness Acc,1.00) (Lameness AUC,1.00) (ID Acc,0.97)};
