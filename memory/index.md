...
- `finalize_viewpoint_expanded_manifest.py`: Applies user adjudications on the 21 disagreements between agent visual predictions and independent ChatGPT vision to finalize `viewpoint_expanded_agent_review_manifest.csv`.
