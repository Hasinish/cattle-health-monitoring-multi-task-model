...
- `modal_export_mtl_sources.py`: Source-side packaging engine running on `tigerwood697` (BCS monolithic tensor chunking to 1024MB parts with SHA-256) and `tigerwood693` (uncompressed tar packaging of 4,271 retained Behavior sequences to 1024MB parts). Enforces strict test-set exclusion.
